...
const POLITICAL_PARTIES = {
  ...
  project2025: {
    ...
    credibleSources: [
      ...
      { name: 'PBS News Explainer', url: 'https://www.pbs.org/newshour/politics/project-2025-director-leaves-heritage-foundation' },
      { name: 'Wikipedia Overview', url: 'https://en.wikipedia.org/wiki/Project_2025' },
...
// FEDERALIST PAPERS - 8 with 9th grade explanations
const FEDERALIST_PAPERS = {
  ...
  summary: 'A series of 85 essays written to persuade New York to ratify the Constitution. Published under the pseudonym "Publius."',
  keyEssays: [
    { number: 1, author: 'Hamilton', title: 'Introduction', tldr: 'Can people choose good government, or does it only happen by force?', ninthGrade: 'Hamilton says this is a huge moment. Can Americans prove people can actually choose their own good government? If we fail, it might prove humans can\'t govern themselves.', famousQuote: '"...whether societies of men are really capable or not of establishing good government from reflection and choice."' },
    { number: 2, author: 'Jay', title: 'Foreign Dangers', tldr: 'We\'re safer together. Thirteen separate countries would invite foreign powers to divide us.', ninthGrade: 'If we split into 13 little countries, Britain and France would play us against each other. United, we\'re too strong. It\'s like a family being safer together.', famousQuote: '"Providence has been pleased to give this one connected country to one united people."' },
    { number: 10, author: 'Madison', title: 'Factions', tldr: 'A big republic controls selfish groups better than a small one.', ninthGrade: 'People form groups (factions) to push their interests. In a BIG country with MANY groups, no single group can bully everyone. They have to compromise.', famousQuote: '"The latent causes of faction are thus sown in the nature of man."' },
    { number: 39, author: 'Madison', title: 'Republican Government', tldr: 'Yes, the Constitution is republican—power comes from the people.', ninthGrade: 'Some worried we\'d create a king. Madison explains: everything comes from the people. Representatives are elected, not born into power.', famousQuote: '"...a government which derives all its powers directly or indirectly from the great body of the people."' },
    { number: 51, author: 'Madison', title: 'Separation of Powers', tldr: 'Make the branches check each other. Don\'t trust anyone with too much power.', ninthGrade: 'If people were angels, we wouldn\'t need government. So we make each part (Congress, President, Courts) able to stop the others from going too far.', famousQuote: '"If men were angels, no government would be necessary."' },
    { number: 70, author: 'Hamilton', title: 'Executive Energy', tldr: 'One President, not a committee. Fast decisions need one person in charge.', ninthGrade: 'Some wanted multiple presidents. Hamilton says that leads to arguing while nothing gets done. One person can act fast and be blamed if things go wrong.', famousQuote: '"Energy in the Executive is a leading character in the definition of good government."' },
    { number: 78, author: 'Hamilton', title: 'Judicial Review', tldr: 'Courts must be able to strike down unconstitutional laws.', ninthGrade: 'The judiciary is the "least dangerous branch"—no army or money. But it can say "this law violates the Constitution." This protects your rights.', famousQuote: '"...has no influence over either the sword or the purse... merely judgment."' },
    { number: 84, author: 'Hamilton', title: 'Against Bill of Rights', tldr: 'Listing rights might imply those are the ONLY rights you have.', ninthGrade: 'Hamilton argued AGAINST a Bill of Rights! His logic: what if we forget to list a right? The 9th Amendment later fixed this concern.', famousQuote: '"Why declare that things shall not be done which there is no power to do?"' },
  ],
  resources: [
    { name: 'Library of Congress', url: 'https://guides.loc.gov/federalist-papers' },
    { name: 'Yale Avalon Project (Full Text)', url: 'https://avalon.law.yale.edu/subject_menus/fed.asp' },
...
const ENGLISH_BILL_OF_RIGHTS = {
  ...
  religiousContext: {
    ...
    explanation: 'When Catholic King James II tried to rule without Parliament, English nobles invited Protestant William & Mary to take the throne. Parliament wrote this Bill to limit royal power.',
  },
  keyProvisions: [
    { provision: 'No royal interference with law', americanInfluence: 'Separation of powers' },
    { provision: 'No taxation without Parliament', americanInfluence: '"No taxation without representation"' },
    { provision: 'Freedom to petition the monarch', americanInfluence: '1st Amendment petition right' },
    { provision: 'Right to bear arms for Protestants', americanInfluence: '2nd Amendment (broadened)' },
    { provision: 'No excessive bail or cruel punishment', americanInfluence: '8th Amendment (nearly identical)' },
  ],
  resources: [
...
const EMANCIPATION_PROCLAMATION = {
  ...
  summary: 'Executive order declaring slaves in Confederate states "forever free." Led to the 13th Amendment.',
  whatItDid: ['Declared slaves in rebelling states free', 'Allowed Black men to serve in Union forces', 'Changed the war\'s purpose to ending slavery'],
  whatItDidNot: ['Did not immediately free any slaves (only applied where Lincoln had no control)', 'Did not abolish slavery everywhere (needed 13th Amendment)', 'Did not grant citizenship or voting (needed 14th/15th)'],
  famousQuote: '"...shall be then, thenceforward, and forever free."',
  resources: [
    { name: 'National Archives (Full Text)', url: 'https://www.archives.gov/exhibits/featured-documents/emancipation-proclamation' },
...
const MAGNA_CARTA = {
  ...
  summary: 'Peace treaty between King John and rebellious barons—foundation of constitutional law.',
  keyPrinciples: [
    { clause: 'Clause 39', original: 'No free man shall be seized or imprisoned... except by lawful judgment.', influence: '5th Amendment, 6th Amendment' },
...
const BILL_OF_RIGHTS_HISTORY = {
  title: 'Bill of Rights: Three Attempts',
  summary: 'The Bill of Rights wasn\'t part of the original Constitution. It took three tries.',
  attempts: [
    { attempt: 1, year: '1787', title: 'Convention - Rejected', outcome: 'REJECTED', description: 'George Mason proposed. Defeated 10-0.' },
    { attempt: 2, year: '1787-88', title: 'Ratification - Promised', outcome: 'PROMISED', description: 'Anti-Federalists demanded. Federalists promised to add one.' },
    { attempt: 3, year: '1789-91', title: 'Congress - RATIFIED', outcome: 'RATIFIED', description: 'Madison introduced 19 → House 17 → Senate 12 → States ratified 10.' },
  ],
  resources: [
...
export default function FoundingDocsView() {
  ...
  const documents = [
    ...
    { id: 'english1689', label: '1689 Bill', icon: Shield },
    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-ink/60 dark:text-paper/60">From Magna Carta to modern parties</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 rounded-lg bg-steel/10 border border-steel/20 flex items-center gap-2">
        ...
        <span className="text-xs text-ink/60 dark:text-paper/60">
          Use <strong className="text-ink dark:text-paper">Research Mode</strong> for source comparison.
        </span>
      </div>
      ...
      {activeDoc === 'parties' && (
        <div className="space-y-4">
          ...
          {/* Project 2025 - just a small note, not prominent */}
          <div className="mt-4 p-3 rounded-lg bg-ink/5 dark:bg-paper/5 text-xs text-ink/60 dark:text-paper/60">
            <p className="mb-2">
              <strong className="text-ink dark:text-paper">Also:</strong> Project 2025 is a policy document from the Heritage Foundation. 
              For factual information, see primary sources:
            </p>
            <div className="flex flex-wrap gap-x-4 gap-y-1">
              <a href="https://www.project2025.org" target="_blank" rel="noopener noreferrer" className="text-steel hover:text-copper">Official Site</a>
              <a href="https://en.wikipedia.org/wiki/Project_2025" target="_blank" rel="noopener noreferrer" className="text-steel hover:text-copper">Wikipedia</a>
              <a href="https://ballotpedia.org/Project_2025" target="_blank" rel="noopener noreferrer" className="text-steel hover:text-copper">Ballotpedia</a>
            </div>
          </div>
        </div>
      )}
      ...
      {activeDoc === 'english1689' && (
        <div className="card">
          ...
          <div className="p-3 rounded-lg bg-copper/10 border border-copper/20 mb-4">
            ...
            <p className="text-sm text-ink/70 dark:text-paper/70">{ENGLISH_BILL_OF_RIGHTS.religiousContext.explanation}</p>
          </div>
      ...
      {activeDoc === 'federalist' && (
        <div className="card">
          ...
          <div className="p-3 rounded-lg bg-forest/10 border border-forest/20 mb-4 flex items-center gap-2">
            ...
            <span className="text-sm text-forest font-medium">9th Grade explanations included</span>
          </div>
          <div className="space-y-3">
                ...
                {expandedSection === `fed${essay.number}` && (
                  <div className="px-3 pb-3 space-y-3">
                    <div className="p-3 rounded-lg bg-forest/10 border border-forest/20">
                      <p className="text-xs text-forest font-semibold mb-1">📚 9th Grade:</p>
      ...
      {activeDoc === 'emancipation' && (
        <div className="card">
          ...
          <p className="text-sm text-ink/60 dark:text-paper/60 mb-2">{EMANCIPATION_PROCLAMATION.issuedBy}</p>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              <h4 className="font-semibold text-burgundy text-sm mb-2">What It Did NOT:</h4>
              <ul className="space-y-1">
