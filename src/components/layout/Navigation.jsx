import { Search, Newspaper, BarChart3, FolderX, Settings, Wrench, HelpCircle, Scale, Shield, Camera, BookOpen } from 'lucide-react'
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`nav-icon flex-shrink-0 ${isActive ? 'active' : ''}`}
